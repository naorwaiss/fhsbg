...
async def process_frames(video_processor_queue, config, filter_config):
    ...
    try:
        ...
        while True:
            ...
            # Remove old objects
            tracked_objects = [obj for obj in tracked_objects if current_time - obj.timestamp < 3]  # Keep objects for 3 seconds
            # Drawing and processing
            for obj in tracked_objects:
                # Draw contours around detected objects
                cv2.drawContours(color_image, [obj.contour], -1, (0, 255, 0), 2)
                # Calculate and filter the positions of objects (just an example, implement your own logic)
                # Note: This requires additional context like 'pixel_to_meters' function and camera FOV settings
